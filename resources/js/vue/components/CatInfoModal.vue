    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       <div class="catInfoModal__wrap">
        <div class="catInfoModal__info">
          <div class="catInfoModal__info__img">
            <img
                class="rounded-3"
          ...
          <div class="catInfoModal__info__content">
            <div class="catInfoModal__info__content__text">
              <div class="catInfoModal__info__info-box__text">
                <h2>編號:{{showCatData.animal_id}}</h2>
              </div>
            </div>
             <div class="catInfoModal__info__info-box__wrap">
              <div class="catInfoModal__info__info-box">
                <div class="catInfoModal__info__info-box__text">
                    <h6>性別</h6>
          ...
          <div class="catInfoModal__info__map"></div>
        </div>
       </div>
      </div>
